...
namespace Example3.Item
{
    ...
    { 
        ...
        static string spreadSheetID = "1A8X2Eum-B_-OVcNwpb86DEpFu13PEK2_gsyYmSwNBnY"; // it is file id
...
#region fuctions
        ...
        public static void Load(bool forceReload = false)
        {
            ...
            string text = reader.ReadData("Example3.Item"); 
            if (text != null)
            {
