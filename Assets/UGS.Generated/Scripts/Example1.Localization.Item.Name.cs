...
namespace Example1.Localization.Item
{
    ...
    { 
        ...
        static string spreadSheetID = "13Sanvic_Qeo7gJHqhH2NrdoSxA2bgWp7lGD3dbli2WA"; // it is file id
...
/* Your Loaded Data Storage. */
        ...
        /// <summary>
        /// Get Name Dictionary, keyType is your sheet A1 field type.
        /// - Auto Load
        /// </summary>
        public static Dictionary<string, Name>  GetDictionary()
        {{
           if (isLoaded == false) Load();
           return NameMap;
        }}
...
#region fuctions
    ...
    public static (List<Name> list, Dictionary<string, Name> map) CommonLoad(Dictionary<string, Dictionary<string, List<string>>> jsonObject, bool forceReload){
            Dictionary<string, Name> Map = new Dictionary<string, Name>();
            List<Name> List = new List<Name>();     
            TypeMap.Init();
            FieldInfo[] fields = typeof(Name).GetFields(BindingFlags.Public | BindingFlags.Instance);
            List<(string original, string propertyName, string type)> typeInfos = new List<(string, string, string)>(); 
            List<List<string>> rows = new List<List<string>>();
            var sheet = jsonObject["Name"];
